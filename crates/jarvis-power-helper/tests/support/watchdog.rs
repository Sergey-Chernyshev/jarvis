...
type Ready =
    jarvis_power_helper::watchdog::ReadyRuntime<FakeBackend, FakeClock, FakeProcesses, FixedRandom>;
...
fn watchdog_is_the_only_post_startup_recovery_trigger_and_ticks_each_second() {
    assert_eq!(
        Watchdog::<FakeBackend, FakeClock, FakeProcesses, FixedRandom>::INTERVAL,
