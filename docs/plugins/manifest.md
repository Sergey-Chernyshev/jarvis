...
The host-private package services additionally test archive inspection, signature
trust, consent, and durable receipts with injected lifecycle ports. This
foundations increment is non-activating: production discovery, launchd lifecycle,
and manager endpoints are separate integration work. Manifest validation never
starts a native entry.
