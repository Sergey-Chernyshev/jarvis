...
use crate::plugin_packages::package_manager::manager::{
...
use crate::plugin_packages::package_manager::random_storage_id;
use crate::plugin_packages::resolver::{
...
mod tests {
    ...
    use crate::plugin_packages::package::HostPackageDocumentAdapter;
    use crate::plugin_packages::package_manager::manager::{
        CatalogProvider, Clock, InstallSourceRef,
    };
    use crate::plugin_packages::package_manager::paths::PluginPaths;
    use crate::plugin_packages::package_manager::receipt::{ReceiptStore, VersionStore};
    use crate::plugin_packages::resolver::{PluginResolver, ResolutionPolicy, ResolvedPlugin};
    use crate::plugin_packages::trust::catalog::CatalogCompatibility;
    use crate::plugin_packages::trust::package::{AllowPackageVerifier, SharedPackageVerifier};
    use crate::plugin_packages::trust::signature::{catalog_digest, catalog_signature_message};
