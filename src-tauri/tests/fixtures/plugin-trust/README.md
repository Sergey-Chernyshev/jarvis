...
from `root-2-test-signing-seed.hex`, a 32-byte Ed25519 test seed whose every byte is `0x07`.
That seed is public test material too; it is intentionally stored only in this fixture directory
and must never be used for releases.
