(() => {
  function a(i, e, n, l) {
    ...
    if (typeof e == "function" ? i !== e || !l : !e.has(i))
      throw new TypeError(
        "Cannot read private member from an object whose class did not declare it",
      );
    return n === "m" ? l : n === "a" ? l.call(i) : l ? l.value : e.get(i);
  }
  function b(i, e, n, l, s) {
    ...
    return (l === "a" ? s.call(i, n) : s ? (s.value = n) : e.set(i, n), n);
  }
  var p,
    h,
    y,
    ...
    constructor(e) {
      (p.set(this, void 0),
        ...
        (this.id = O((n) => {
          let l = n.index;
          if ("end" in n) {
            l == a(this, h, "f") ? this.cleanupCallback() : b(this, W, l, "f");
            return;
          }
          let s = n.message;
          if (l == a(this, h, "f")) {
            for (
              a(this, p, "f").call(this, s),
                b(this, h, a(this, h, "f") + 1, "f");
              a(this, h, "f") in a(this, y, "f");
            ) {
              let g = a(this, y, "f")[a(this, h, "f")];
              (a(this, p, "f").call(this, g),
                delete a(this, y, "f")[a(this, h, "f")],
                b(this, h, a(this, h, "f") + 1, "f"));
            }
            a(this, h, "f") === a(this, W, "f") && this.cleanupCallback();
          } else a(this, y, "f")[l] = s;
        })));
    }
    cleanupCallback() {
  ...
  async function t(i, e = {}, n) {
    return window.__TAURI_INTERNALS__.invoke(i, e, n);
  }
  var C = class {
    get rid() {
      return a(this, I, "f");
    ...
    constructor(e) {
      (I.set(this, void 0), b(this, I, e, "f"));
    }
    async close() {
  ...
  async function E(i, e) {
    (window.__TAURI_EVENT_PLUGIN_INTERNALS__.unregisterListener(i, e),
      await t("plugin:event|unlisten", { event: i, eventId: e }));
  }
  async function m(i, e, n) {
    var l;
    let s =
      typeof n?.target == "string"
        ? { kind: "AnyLabel", label: n.target }
        : (l = n?.target) !== null && l !== void 0
          ? l
          : { kind: "Any" };
  ...
  async function P(i, e) {
    await t("plugin:event|emit", { event: i, payload: e });
  }
  async function M(i, e, n) {
  ...
  var f = class {
      constructor(...e) {
        ((this.type = "Logical"),
          e.length === 1
            ? "Logical" in e[0]
              ? ((this.width = e[0].Logical.width),
                (this.height = e[0].Logical.height))
    ...
    w = class {
      constructor(...e) {
        ((this.type = "Physical"),
          e.length === 1
            ? "Physical" in e[0]
              ? ((this.width = e[0].Physical.width),
                (this.height = e[0].Physical.height))
              : ((this.width = e[0].width), (this.height = e[0].height))
            : ((this.width = e[0]), (this.height = e[1])));
      }
      toLogical(e) {
    ...
    _ = class {
      ...
      toLogical(e) {
        return this.position instanceof v
          ? this.position
          : this.position.toLogical(e);
      }
      toPhysical(e) {
        return this.position instanceof c
          ? this.position
  ...
  var N = class i extends C {
    constructor(e) {
      super(e);
    }
    static async new(e, n, l) {
      return t("plugin:image|new", { rgba: D(e), width: n, height: l }).then(
        (s) => new i(s),
      );
    }
    static async fromBytes(e) {
      return t("plugin:image|from_bytes", { bytes: D(e) }).then(
        (n) => new i(n),
      );
    }
    static async fromPath(e) {
      return t("plugin:image|from_path", { path: e }).then((n) => new i(n));
    }
    async rgba() {
  ...
  var z;
  (function (i) {
    ((i[(i.Critical = 1)] = "Critical"),
      (i[(i.Informational = 2)] = "Informational"));
  })(z || (z = {}));
  var k = class {
      constructor(e) {
  ...
  function x() {
    return new A(window.__TAURI_INTERNALS__.metadata.currentWindow.label, {
      skip: !0,
    });
  }
  async function R() {
    return t("plugin:window|get_all_windows").then((i) =>
      i.map((e) => new A(e, { skip: !0 })),
    );
  }
  var S = ["tauri://created", "tauri://error"],
    A = class {
      constructor(e, n = {}) {
        var l;
        ((this.label = e),
          ...
          n?.skip ||
            t("plugin:window|create", {
              options: {
                ...n,
                parent:
                  typeof n.parent == "string"
                    ? n.parent
                    : (l = n.parent) === null || l === void 0
                      ? void 0
                      : l.label,
                label: e,
              },
      ...
      static async getByLabel(e) {
        var n;
        return (n = (await R()).find((l) => l.label === e)) !== null &&
          n !== void 0
          ? n
          : null;
      }
      ...
      static async getFocusedWindow() {
        for (let e of await R()) if (await e.isFocused()) return e;
        return null;
      }
      async listen(e, n) {
        return this._handleTauriEvent(e, n)
          ...
          : m(e, n, { target: { kind: "Window", label: this.label } });
      }
      async once(e, n) {
        return this._handleTauriEvent(e, n)
          ? () => {
      ...
      async emit(e, n) {
        if (S.includes(e)) {
          for (let l of this.listeners[e] || [])
            l({ event: e, id: -1, payload: n });
          return;
        }
        return P(e, n);
      }
      async emitTo(e, n, l) {
        if (S.includes(n)) {
          for (let s of this.listeners[n] || [])
            s({ event: n, id: -1, payload: l });
          return;
        }
        return M(e, n, l);
      }
      ...
      async innerPosition() {
        return t("plugin:window|inner_position", { label: this.label }).then(
          (e) => new c(e),
        );
      }
      async outerPosition() {
        return t("plugin:window|outer_position", { label: this.label }).then(
          (e) => new c(e),
        );
      }
      async innerSize() {
        return t("plugin:window|inner_size", { label: this.label }).then(
          (e) => new w(e),
        );
      }
      async outerSize() {
        return t("plugin:window|outer_size", { label: this.label }).then(
          (e) => new w(e),
        );
      }
      async isFullscreen() {
      ...
      async requestUserAttention(e) {
        ...
        return (
          ...
          t("plugin:window|request_user_attention", {
            label: this.label,
            value: n,
          })
        );
      ...
      async setMinSize(e) {
        return t("plugin:window|set_min_size", {
          label: this.label,
          value: e instanceof d ? e : e ? new d(e) : null,
        });
      }
      async setMaxSize(e) {
      ...
      async setSimpleFullscreen(e) {
        return t("plugin:window|set_simple_fullscreen", {
          label: this.label,
          value: e,
        });
      }
      ...
      async setFocusable(e) {
        return t("plugin:window|set_focusable", {
          label: this.label,
          value: e,
        });
      }
      async setIcon(e) {
        return t("plugin:window|set_icon", { label: this.label, value: D(e) });
      }
      ...
      async onDragDropEvent(e) {
        let n = await this.listen(o.DRAG_ENTER, (u) => {
            e({
              ...u,
              payload: {
                type: "enter",
                paths: u.payload.paths,
                position: new c(u.payload.position),
              },
            });
          }),
          l = await this.listen(o.DRAG_OVER, (u) => {
            e({
              ...u,
              payload: { type: "over", position: new c(u.payload.position) },
            });
          }),
          s = await this.listen(o.DRAG_DROP, (u) => {
            e({
              ...u,
              payload: {
                type: "drop",
          ...
          g = await this.listen(o.DRAG_LEAVE, (u) => {
      ...
      async onFocusChanged(e) {
        let n = await this.listen(o.WINDOW_FOCUS, (s) => {
            e({ ...s, payload: !0 });
          }),
          l = await this.listen(o.WINDOW_BLUR, (s) => {
            e({ ...s, payload: !1 });
          });
        return () => {
          (n(), l());
  ...
  var V;
  (function (i) {
    ((i.FollowsWindowActiveState = "followsWindowActiveState"),
      (i.Active = "active"),
      (i.Inactive = "inactive"));
  })(V || (V = {}));
