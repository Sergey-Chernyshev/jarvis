...
`;
  ...
  const NAV = [
    ...
    { pane: 'plugins', label: 'Плагины', icon: 'blocks', ic: 'violet', find: 'плагины расширения способности манифест тумблер права' },
    { sep: true },
    { pane: 'service', label: 'Под капотом', icon: 'cpu', ic: 'purple', find: 'служебный llm бэкенд саммари egress прокси аккаунт claude api-ключ модель codex sdk сайдкар' },
   ...
   * держит бюджет). Разложить остальные два десятка id
